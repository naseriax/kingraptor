...
```
{
    ...
    "cycleQty" : 6,                    //Specifies how many time the utilization values must be collected from NEs.(If the utilization is high for any NE in all cycles, it's considered High and will initiate email notification.)
